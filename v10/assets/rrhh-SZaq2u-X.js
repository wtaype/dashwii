import{i as e}from"./vendor-CKz6wYoq.js";import{d as t,i as n,m as r,n as i,p as a,t as o}from"./widev-C5MihLHB.js";import"./index-DlnccYRf.js";import{M as s,O as c,_ as l,k as u,w as d}from"./firebase-DitBirJH.js";import{n as f}from"./firebase-Cv7jjlDy.js";var p=[],m=`todos`,h=``,g=null,_=!1,v=`rrhhUsuarios`,y=30,b=e=>((e.nombre||``)+` `+(e.apellidos||``)||e.usuario||`?`).trim().split(/\s+/).slice(0,2).map(e=>(e[0]||``).toUpperCase()).join(``),x=(e,t=40)=>{if(e.imagen)return`<div class="rrhh_avatar" style="width:${t}px;height:${t}px"><img src="${e.imagen}" alt="${o(e.nombre||e.usuario||`?`)}" loading="lazy"/></div>`;let n=b(e);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${e.rol||`smile`}" style="width:${t}px;height:${t}px;font-size:${Math.round(t*.36)}px">${n}</div>`},S=e=>{let t=(e||`smile`).toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${t}">${o(t)}</span>`},C=(e,t)=>{let n=t===`activo`;return`
