import{i as e}from"./vendor-CKz6wYoq.js";import{t}from"./wii-CfHJrYZI.js";import{C as n,_ as r,a as i,d as a,g as o,i as s,l as c,m as l,w as u,y as d}from"./widev-C5MihLHB.js";import{i as f}from"./index-DlnccYRf.js";var p=`word_docs`,m=()=>`wd`+Date.now(),h=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],g={get:()=>{let e=localStorage.getItem(p);return e===null&&!r.user?[...h]:a(p)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>l(p,e,8760)},_=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
