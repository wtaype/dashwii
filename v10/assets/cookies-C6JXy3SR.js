...
<div class="ac_wrap tm_wrap">
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <p class="ac_hero_sub">Te explicamos cómo usamos el almacenamiento local y la caché técnica de tu dispositivo para garantizar el funcionamiento rápido de <strong>${t}</strong>.</p>
      ...
      <div class="tm_last_upd"><i class="fas fa-calendar-check"></i> Última actualización: ${n()} · Versión v10</div>
    </div>
  </section>
...
</div></main>`,s=null,c=()=>{s=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)}),{threshold:.1}),e(`.wi_fadeUp`).each(function(){s.observe(this)}),e(document).on(`click.cookies`,`.tm_nav`,function(t){t.preventDefault(),r(()=>import(`./index-DlnccYRf.js`).then(e=>e.r).then(t=>t.rutas.navigate(e(this).attr(`href`))),[])}),console.log(`🍪 ${t} Cookies cargada`),window.__WIREADY__=!0},l=()=>{s?.disconnect?.(),s=null,e(document).off(`.cookies`)};export{l as cleanup,c as init,o as render};