import{n as e}from"./vendor-BuoCFfzO.js";import{n as t,t as n}from"./wii-CfHJrYZI.js";import{E as r}from"./widev-j_LPqVJz.js";import{i}from"./index-DfUZS8On.js";/* empty css               */var a=()=>`
<main id="wimain">
<div class="ac_wrap">
  ...
  <section class="ac_hero">
    ...
    <div class="ac_hero_body">
      <div class="ac_hero_logo" style="border:none; border-radius: 20px;">
        <img src="/smile.avif" alt="${n}" loading="lazy" style="border-radius:20px;">
      </div>
      <div class="ac_hero_badge"><i class="fas fa-cake-candles"></i> Cumpleaños, cariño y memoria</div>
      <h1 class="ac_hero_tit">${n}</h1>
      <p class="ac_hero_sub">
  ...
  <section class="ac_sec">
    <div class="ac_sec_head">
      ...
      <h2 class="ac_sec_tit">Por qué <span class="ac_grad">${n}</span></h2>
    </div>
    <div class="ac_historia wi_fadeUp">
      <p><strong>${n}</strong> nace para que ninguna fecha especial se pierda entre el trabajo, los mensajes y la prisa diaria. Guardas cumpleaños, relación, notas, ideas de regalo, foto y color; la app te ayuda a recordar con tiempo y con cariño.</p>
      ...
      <div class="ac_firma">
        <strong>Con cariño, ${t}</strong>
        <span>Diseño y Desarrollo · ${n}</span>
      </div>
    </div>
  </section>
  ...
  <section class="ac_sec ac_sec_alt">
    <div class="ac_sec_head">
      ...
      <p class="ac_sec_sub">Testimonios reales sobre cómo ${n} ha facilitado sus vidas</p>
    </div>
  ...
  <section class="ac_sec">
    <div class="ac_sec_head">
      ...
      <h2 class="ac_sec_tit">Explora más <span class="ac_grad">de ${n}</span></h2>
...
`,o=()=>{let t=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)})},{threshold:.1});e(`.wi_fadeUp`).each(function(){t.observe(this)}),e(`#ac_compartir`).on(`click`,function(){let e=window.location.origin;navigator.share?navigator.share({title:n,text:`🎉 Organiza tus cumpleaños y celebraciones de forma veloz, segura y premium con ${n}. ¡Pruébalo!`,url:e}).catch(()=>{}):r(e,this,`¡Link copiado!`)}),e(document).on(`click.acerca`,`.nv_item`,function(t){let n=e(this).attr(`href`);n&&n.startsWith(`/`)&&(t.preventDefault(),i(()=>import(`./index-DfUZS8On.js`).then(e=>e.r).then(e=>e.rutas.navigate(n)),[]))}),window.wiInitTips&&window.wiInitTips(),console.log(`🛡️ ${n} Acerca actualizado`),window.__WIREADY__=!0},s=()=>{e(`#ac_compartir`).off(`click`),e(document).off(`.acerca`)};export{s as cleanup,o as init,a as render};