import{i as e}from"./vendor-CKz6wYoq.js";import{t}from"./wii-CfHJrYZI.js";import{E as n,a as r,d as i,i as a,w as o}from"./widev-5auSvXDH.js";import{n as s}from"./index-CCDQ42ns.js";import{M as c,O as l,S as u,T as d,_ as f,k as p,m,v as h,x as g}from"./firebase-DitBirJH.js";import{n as _,t as v}from"./firebase-Cv7jjlDy.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>i(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
